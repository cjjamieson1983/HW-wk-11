...
10.221.1.0/24 10.221.2.0/24 10.221.3.0/24

Private

10.221.11.0/24 10.221.12.0/24 10.221.13.0/24

2.) Go to aws_vpc | Resources | hashicorp/aws | Terraform | Terraform Registry to find code for your VPC resource. Make sure you have your correct terraform version selected when pulling documentation.

3.) Copy Basic usage with Tags

resource "aws_vpc" "main" { cidr_block = "10.0.0.0/16" instance_tenancy = "default"
...
Class7-notes/110225/4-nat.tf at main · aaron-dm-mcdonald/Class7-notes

Edit any necessary names or ID’s and Terraform IPAD.

12.) Create a 5-RTB file. (Route Tables) From Aarons repo copy the RTB file. Class7-notes/110225 at main · aaron-dm-mcdonald/Class7-notes

Edit VPC IDs, Subnet ID’s and names as necessary to match your Network, then Terraform IPAD.

13.) Create a 6b-SG terraform file Go to aws_security_group | Resources | hashicorp/aws | Terraform | Terraform Registry . Copy the Basic usage code. Add it to your SG file.
...
14.) Create a 6a-ALB-SG Terraform file. Go to aws_security_group | Resources | hashicorp/aws | Terraform | Terraform Registry. Copy basic usage. Add to your ALB SG file.
...
User data- to call up user.data.sh file you need the filebase64 command
...
Create 8-TG Terraform file. To create your ALB Target Group go to aws_lb_target_group | Resources | hashicorp/aws | Terraform | Terraform Registry . Copy the instance Example from the documentation. Find arguments for Health Checks. Edit necessary names, ID’s. IPAD

Create 10a-Load_Balancer terraform file. To create the load balancer go to aws_lb | Resources | hashicorp/aws | Terraform | Terraform Registry . Copy the Application load balancer Example. Add to your Tf file.

Edit your names, SG ID, add your “Public” subnets, Deletion protection to false. IPAD

Create 10b-Lb-listener terraform file. Go to aws_lb_listener | Resources | hashicorp/aws | Terraform | Terraform Registry. Copy the Forward action argument. Add to your listener file.

Delete the certificate Arn, and the ssl policy arguments. Edit prt to 80, protocol to http, Edit necessary arn’s. IPAD

Create 9-ASG terraform file. Go to aws_autoscaling_group | Resources | hashicorp/aws | Terraform | Terraform Registry. Scroll to the with latest version example. Copy all of the second resource block. Add to file.
...
Create an 11-scaling_policy terraform file. Go to aws_autoscaling_policy | Resources | hashicorp/aws | Terraform | Terraform Registry. Copy the first resource block, remove everything except, name and auto scaling group name .
...
Create a 12-attachment terraform file. Go to aws_autoscaling_attachment | Resources | hashicorp/aws | Terraform | Terraform Registry. Copy ALB example, and add to your Attachment terraform file. Edit necessary, names ID’s, Arn’s. IPAD
